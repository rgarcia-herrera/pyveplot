...
% For example, one of the key strengths of a HP is that the placement of
% nodes along axes can obey whatever criteria makes the data clear.
% Place along an axis might represent connectedness degree, centrality, age, distance, 

% By decoupling mechanism from policy

% Making full use of the visual 
% capabilities of visual display of information
% In order to reveal patterns in the data.

% The full use of HPs capabilities requires a way of expressing the
% shapes and drawings. 

% that matches in descriptive power the complexity of
% the graph.

% GUIs require exchange formats and such .dot, .sif. 
