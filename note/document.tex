...
\begin{figure}
  % a hiveplot of four axes growing in golden ratio
  % the longest should harbor large ammount of low degree nodes
  % split into four quartiles
  % fake chromosome using dashed pattern
